...
def lcd_init(backlight=LCD_BACKLIGHT_ON):
  # Initialise display
...
def lcd_byte(bits, mode,backlight=LCD_BACKLIGHT_ON):
...
def lcd_string(message,line,backlight=LCD_BACKLIGHT_ON):
  ...
  for i in range(LCD_WIDTH):
    lcd_byte(ord(message[i]),LCD_CHR,backlight)